...
s32 func_80A7BE6C(EnInsect* this, GlobalContext* globalCtx) {
    ...
    if (this->actor.xzDistFromLink < 32.0f) {
        pos.x = Math_Sins(this->actor.yawTowardsLink + 0x8000) * 16.0f + player->actor.world.pos.x;
        pos.y = player->actor.world.pos.y;
        pos.z = Math_Coss(this->actor.yawTowardsLink + 0x8000) * 16.0f + player->actor.world.pos.z;
...
void func_80A7C5EC(EnInsect* this, GlobalContext* globalCtx) {
    ...
    if (EnInsect_XZDistanceSquared(&this->actor.world.pos, &this->actor.home.pos) > 1600.0f ||
        (this->unk_31A < 4)) {
        Math_ApproxUpdateScaledS(&this->actor.world.rot.y,
                                 Math_Vec3f_Yaw(&this->actor.world.pos, &this->actor.home.pos), 2000);
    } else if (this->actor.child != NULL && &this->actor != this->actor.child) {
        Math_ApproxUpdateScaledS(&this->actor.world.rot.y,
                                 Math_Vec3f_Yaw(&this->actor.world.pos, &this->actor.child->world.pos), 2000);
    }
...
void func_80A7C86C(EnInsect* this, GlobalContext* globalCtx) {
    ...
    if (EnInsect_XZDistanceSquared(&this->actor.world.pos, &this->actor.home.pos) > 25600.0f ||
        ...
        Math_ApproxUpdateScaledS(&this->actor.world.rot.y, phi_a1, 2000);
    }
...
void func_80A7CC3C(EnInsect* this, GlobalContext* globalCtx) {
    ...
    this->actor.world.pos.x = Math_Rand_ZeroOne() + this->actor.home.pos.x - 0.5f;
    this->actor.world.pos.z = Math_Rand_ZeroOne() + this->actor.home.pos.z - 0.5f;
    ...
    if (this->unk_31A > 20 && Math_Rand_ZeroOne() < 0.1f) {
        ...
        func_800286CC(globalCtx, &this->actor.world.pos, &velocity, &accel, Math_Rand_ZeroOne() * 5.0f + 8.0f,
...
void func_80A7CEC0(EnInsect* this, GlobalContext* globalCtx) {
    ...
    this->actor.world.pos.y += this->actor.waterY;
    ...
    Math_ApproxUpdateScaledS(&this->actor.world.rot.x, 0, 3000);
    this->actor.shape.rot.x = this->actor.world.rot.x;

    if (Math_Rand_ZeroOne() < 0.03f) {
        sp40.x = this->actor.world.pos.x;
        sp40.y = this->actor.world.pos.y + this->actor.waterY;
...
void func_80A7D39C(EnInsect* this) {
    ...
    this->actor.world.rot.y = Math_Rand_ZeroOne() * 65535.5f;
...
void func_80A7D460(EnInsect* this, GlobalContext* globalCtx) {
    ...
    if (this->soilActor != NULL && Math_Rand_ZeroOne() < 0.07f) {
        this->actor.home.pos.x = (Math_Rand_ZeroOne() - 0.5f) * phi_f2 + thisTemp->soilActor->actor.world.pos.x;
        this->actor.home.pos.y = thisTemp->soilActor->actor.world.pos.y;
        this->actor.home.pos.z = (Math_Rand_ZeroOne() - 0.5f) * phi_f2 + thisTemp->soilActor->actor.world.pos.z;
    }
    ...
    if (this->actor.bgCheckFlags & 1) {
        ...
        Math_ApproxUpdateScaledS(&this->actor.world.rot.y, this->unk_328, 2000);
        sp50 = Math_ApproxUpdateScaledS(&this->actor.world.rot.x, 0, 2000);
        this->actor.shape.rot.y = this->actor.world.rot.y;
        this->actor.shape.rot.x = this->actor.world.rot.x;
    } else {
        Math_SmoothScaleMaxMinF(&this->actor.speedXZ, 0.0f, 0.1f, 0.5f, 0.0f);
