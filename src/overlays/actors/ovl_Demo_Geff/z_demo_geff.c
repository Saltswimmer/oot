...
void func_809782A0(DemoGeff* this, GlobalContext* globalCtx) {
    ...
    if (demoGt != NULL && (params != 6) && (params != 7) && (params != 8)) {
        this->actor.world.pos.x = demoGt->actor.world.pos.x + this->deltaPosX;
        this->actor.world.pos.y = demoGt->actor.world.pos.y + this->deltaPosY;
        this->actor.world.pos.z = demoGt->actor.world.pos.z + this->deltaPosZ;
    }
}
