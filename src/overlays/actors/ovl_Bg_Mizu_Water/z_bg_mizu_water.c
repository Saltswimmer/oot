...
void BgMizuWater_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    switch (this->type) {
        ...
        case 2:
            ...
            waterBoxes[6].unk_02 = this->actor.world.pos.y;
            break;
        case 3:
            if (Flags_GetSwitch(globalCtx, this->switchFlag)) {
            ...
            waterBoxes[8].unk_02 = this->actor.world.pos.y;
            break;
        case 4:
            if (Flags_GetSwitch(globalCtx, this->switchFlag)) {
            ...
            waterBoxes[16].unk_02 = this->actor.world.pos.y;
            break;
    }
...
void BgMizuWater_ChangeWaterLevel(BgMizuWater* this, GlobalContext* globalCtx) {
    ...
    switch (this->type) {
        case 0:
            ...
            if (Math_ApproxF(&this->actor.world.pos.y, this->targetY, 5.0f)) {
                globalCtx->unk_11D30[0] = 0;
                this->actionFunc = BgMizuWater_WaitForAction;
                func_80106CCC(globalCtx);
            }
            BgMizuWater_SetWaterBoxesHeight(globalCtx->colCtx.stat.colHeader->waterBoxes, this->actor.world.pos.y);
            break;
        case 1:
            break;
        case 2:
            ...
            if (Math_ApproxF(&this->actor.world.pos.y, this->targetY, 1.0f)) {
                globalCtx->unk_11D30[0] = 0;
                this->actionFunc = BgMizuWater_WaitForAction;
            }
            waterBoxes[6].unk_02 = this->actor.world.pos.y;
