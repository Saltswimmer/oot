...
void BgJyaMegami_Explode(BgJyaMegami* this, GlobalContext* globalCtx) {
    ...
    if ((this->explosionTimer % 4 == 0) && (this->explosionTimer > 30) && (this->explosionTimer < 80) &&
        ...
        sp8C.x = ((Math_Rand_ZeroOne() - 0.5f) * 90.0f) + this->dyna.actor.world.pos.x;
        sp8C.y = (this->dyna.actor.world.pos.y - (Math_Rand_ZeroOne() * 80.0f)) - 20.0f;
        sp8C.z = this->dyna.actor.world.pos.z - ((Math_Rand_ZeroOne() - 0.5f) * 50.0f);
