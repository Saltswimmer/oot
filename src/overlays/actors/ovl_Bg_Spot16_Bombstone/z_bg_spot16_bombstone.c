...
void BgSpot16Bombstone_SpawnFragments(BgSpot16Bombstone* this, GlobalContext* globalCtx) {
    ...
    if (index < ARRAY_COUNT(D_808B6074)) {
        do {
            pos.x = ((Math_Rand_ZeroOne() - 0.5f) * 8.0f) + this->actor.world.pos.x;
            pos.y = ((Math_Rand_ZeroOne() * 5.0f) + this->actor.world.pos.y) + 8.0f;
            pos.z = ((Math_Rand_ZeroOne() - 0.5f) * 8.0f) + this->actor.world.pos.z;
