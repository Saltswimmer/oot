...
void func_808B9698(BgSpot18Shutter* this, GlobalContext* globalCtx) {
    if (Math_ApproxF(&this->dyna.actor.world.pos.y, this->dyna.actor.home.pos.y + 180.0f, 1.44f)) {
...
void func_808B971C(BgSpot18Shutter* this, GlobalContext* globalCtx) {
    ...
    s32 flag =
        Math_ApproxF(&this->dyna.actor.world.pos.x, this->dyna.actor.home.pos.x + (125.0f * cos), fabsf(cos)) &
        1;
    flag &=
        Math_ApproxF(&this->dyna.actor.world.pos.z, this->dyna.actor.home.pos.z - (125.0f * sin), fabsf(sin));
