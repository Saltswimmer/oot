...
void BgHeavyBlock_SetPieceRandRot(BgHeavyBlock* this, f32 scale) {
    this->dyna.actor.world.rot.x = Math_Rand_CenteredFloat(1024.0f) * scale;
    this->dyna.actor.world.rot.y = Math_Rand_CenteredFloat(1024.0f) * scale;
    this->dyna.actor.world.rot.z = Math_Rand_CenteredFloat(1024.0f) * scale;
}
...
void BgHeavyBlock_Draw(Actor* thisx, GlobalContext* globalCtx) {
    ...
    Matrix_MultVec3f(&D_80884EC8, &thisx->world);
    Matrix_MultVec3f(&D_80884ED4, &thisx->home);
