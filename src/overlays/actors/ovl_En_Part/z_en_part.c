...
void func_80ACDDE8(EnPart* this, GlobalContext* globalCtx) {
    ...
    this->action = 1;
    this->actor.world.rot.y = Math_Rand_ZeroOne() * 20000.0f;
...
void func_80ACE13C(EnPart* this, GlobalContext* globalCtx) {
    ...
    if ((this->actor.params == 12) || (this->actor.params == 13)) {
        ...
        if ((this->actor.bgCheckFlags & 1) || (this->actor.world.pos.y <= this->actor.groundY)) {
            this->action = 4;
        ...
        switch (this->actor.params) {
            ...
            case 4:
                for (i = 7; i >= 0; i--) {
                    pos.x = this->actor.world.pos.x + Math_Rand_CenteredFloat(60.0f);
                    pos.y = this->actor.world.pos.y + this->actor.shape.unk_08 * this->actor.scale.y +
                            Math_Rand_CenteredFloat(50.0f);
                    pos.z = this->actor.world.pos.z + Math_Rand_CenteredFloat(60.0f);
            ...
            case 8:
                for (i = 4; i >= 0; i--) {
                    pos.x = this->actor.world.pos.x + Math_Rand_CenteredFloat(25.0f);
                    pos.y = this->actor.world.pos.y + Math_Rand_CenteredFloat(40.0f);
                    pos.z = this->actor.world.pos.z + Math_Rand_CenteredFloat(25.0f);
...
void func_80ACE7E8(EnPart* this, GlobalContext* globalCtx) {
    ...
    if (this->timer == 0) {
        f32 diffsSum =
            Math_SmoothScaleMaxMinF(&this->actor.world.pos.x, this->actor.home.pos.x, 1.0f, 5.0f, 0.0f);
        diffsSum += Math_SmoothScaleMaxMinF(&this->actor.world.pos.y, this->actor.home.pos.y, 1.0f, 5.0f, 0.0f);
        diffsSum += Math_SmoothScaleMaxMinF(&this->actor.world.pos.z, this->actor.home.pos.z, 1.0f, 5.0f, 0.0f);
