    ...
    if (thisx->params != HAKA_TRAP_PROPELLER) {
        ...
        if ((thisx->params == HAKA_TRAP_GUILLOTINE_SLOW) || (thisx->params == HAKA_TRAP_GUILLOTINE_FAST)) {
            ...
            if (thisx->params == HAKA_TRAP_SPIKED_BOX) {
                ...
                thisx->groundY = thisx->home.pos.y - 225.0f;
...
void func_808801B8(BgHakaTrap* this, GlobalContext* globalCtx) {
    ...
    if ((D_80880F30 == 0) && (!Player_InCsMode(globalCtx))) {
        if (!Math_ApproxF(&this->dyna.actor.world.pos.x, this->dyna.actor.home.pos.x, 0.5f)) {
...
void func_808802D8(BgHakaTrap* this, GlobalContext* globalCtx) {
    ...
    for (i = 0; i < 2; i++) {
        ...
        vector.y = Math_Rand_ZeroOne() * 10.0f + this->dyna.actor.world.pos.y + 30.0f;
        vector.z = Math_Rand_CenteredFloat(320.0f) + this->dyna.actor.world.pos.z;
...
void func_80880484(BgHakaTrap* this, GlobalContext* globalCtx) {
    ...
    sp24 = Math_ApproxF(&this->dyna.actor.world.pos.y, this->dyna.actor.home.pos.y - 185.0f,
...
void func_808805C0(BgHakaTrap* this, GlobalContext* globalCtx) {
    ...
    if (this->unk_16A) {
        Math_ApproxF(&this->dyna.actor.world.pos.y, this->dyna.actor.home.pos.y, 27.0f);
    } else {
        if (this->timer > 20) {
            Math_ApproxF(&this->dyna.actor.world.pos.y, this->dyna.actor.home.pos.y - 90.0f, 9.0f);
        } else {
            Math_ApproxF(&this->dyna.actor.world.pos.y, this->dyna.actor.home.pos.y, 4.5f);
        }
...
void func_808806BC(BgHakaTrap* this, GlobalContext* globalCtx) {
    ...
    if (Math_ApproxF(&this->dyna.actor.world.pos.y, tempf20, this->dyna.actor.velocity.y)) {
...
void func_808808F4(BgHakaTrap* this, GlobalContext* globalCtx) {
    ...
    if (this->timer > 20) {
        this->unk_169 = Math_ApproxF(&this->dyna.actor.world.pos.y, this->unk_16A, 15.0f);
    } else {
        this->unk_169 = Math_ApproxF(&this->dyna.actor.world.pos.y, this->dyna.actor.home.pos.y, 20.0f);
    }
...
void func_80880AE8(BgHakaTrap* this, GlobalContext* globalCtx) {
    if (this->timer != 0) {
        if (Math_ApproxUpdateScaledS(&this->dyna.actor.world.rot.z, 0, this->dyna.actor.world.rot.z * 0.03f + 5.0f)) {
            this->timer = 40;
            this->actionFunc = func_808809B0;
        }
    } else {
        if (Math_ApproxUpdateScaledS(&this->dyna.actor.world.rot.z, 0x3A00,
                                     this->dyna.actor.world.rot.z * 0.03f + 5.0f)) {
            this->timer = 100;
