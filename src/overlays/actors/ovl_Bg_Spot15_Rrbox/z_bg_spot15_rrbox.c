...
s32 func_808B3CA0(BgSpot15Rrbox* this, GlobalContext* globalCtx, s32 arg2) {
    ...
    if ((this->dyna.actor.groundY - this->dyna.actor.world.pos.y) >= -0.001f) {
        this->dyna.actor.world.pos.y = this->dyna.actor.groundY;
        return true;
    }
    return false;
}
...
void func_808B43D0(BgSpot15Rrbox* this, GlobalContext* globalCtx) {
    ...
    if ((groundY - actor->world.pos.y) >= -0.001f) {
        actor->world.pos.y = groundY;
        func_808B4084(this, globalCtx);
