...
void EnWallmas_SetupDrop(EnWallmas* this, GlobalContext* globalCtx) {
    ...
    this->unk_2c4 = player->actor.world.pos.y;
...
void EnWallmas_Stand(EnWallmas* this, GlobalContext* globalCtx) {
    ...
    Math_ApproxUpdateScaledS(&this->actor.world.rot.y, this->actor.yawTowardsLink + 0x8000, 0xB6);
}
...
void EnWallmas_Walk(EnWallmas* this, GlobalContext* globalCtx) {
    ...
    Math_ApproxUpdateScaledS(&this->actor.world.rot.y, (s16)((s32)this->actor.yawTowardsLink + 0x8000), 0xB6);
...
void EnWallmas_TakePlayer(EnWallmas* this, GlobalContext* globalCtx) {
    ...
    if (SkelAnime_FrameUpdateMatrix(&this->skelAnime) != 0) {
        ...
        Math_ApproxF(&this->actor.world.pos.y, player->actor.world.pos.y + (LINK_IS_CHILD ? 30.0f : 50.0f), 5.0f);
    }

    Math_ApproxF(&this->actor.world.pos.x, player->actor.world.pos.x, 3.0f);
    Math_ApproxF(&this->actor.world.pos.z, player->actor.world.pos.z, 3.0f);
...
void EnWallmas_Update(Actor* thisx, GlobalContext* globalCtx) {
    ...
    } else if (this->actor.world.pos.y <= this->unk_2c4) {
        this->actor.world.pos.y = this->unk_2c4;
        this->actor.velocity.y = 0.0f;
...
void EnWallmas_DrawXlu(EnWallmas* this, GlobalContext* globalCtx) {
    ...
    func_80038A28(this->actor.floorPoly, this->actor.world.pos.x, this->actor.groundY, this->actor.world.pos.z, &mf);
